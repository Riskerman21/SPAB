const dict = {'Sakon Nakhon': ['Akat Amnuai', 'Ban Muang', 'Charoen Sin', 'Kham Ta Kla', 'Khok Si Suphan', 'Kusuman', 'Kut Bak', 'Mueang Sakon Nakhon', 'Nikhom Nam Un', 'Phang Khon', 'Phanna Nikhom', 'Phon Na Kaeo', 'Phu Phan', 'Sawang Daen Din', 'Song Dao', 'Tao Ngoi', 'Wanon Niwat', 'Waritchaphum'], 
    ...
    document.getElementById('predict-button').addEventListener('click', function(event) {
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                <h2>Predicted Risk: ${riskValue}%</h2>
                <div class="${riskClass}">${capitalizeFirstLetter(riskClass)}</div>
                <div class="current-risk" style="width: ${riskValue}%"></div>
                `;
                // Show the risk meter after updating
